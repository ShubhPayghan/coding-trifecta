/*
    ...
    write mode, reads the first 10 bytes from the file into one buffer 
    (Arr), and then reads the next 12 bytes into another buffer (Brr).
    Display the data read from both buffers. If the file doesn't exist 
    or cannot be opened, an appropriate error message should be displayed.
*/
#include<stdio.h>
#include<stdlib.h>
#include<unistd.h>
