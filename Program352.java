/* 
    this code is incomplete bcoz here we can learn how to create a loo
*/
...
class Program352
{
    public static void main(String arg[]) throws Exception
    {
        ...
        while()
        {
            ...
            int FileSize = Integer.parseInt(Tokens[1]);  //parsing means conversion(like typecast)

            byte Buffer[]= new byte[FileSize];

            fiobj.read(Buffer,0,FileSize); //read data
